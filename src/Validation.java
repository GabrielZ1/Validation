...
if (randomNumber==2) {
	JOptionPane.showMessageDialog(null, "Your shirt is awesome");
...
if (randomNumber==4) {
	JOptionPane.showMessageDialog(null, "Your voice sounds nice");
	
	
}
if (randomNumber==5) {
JOptionPane.showMessageDialog(null, "Stay happy!");	
